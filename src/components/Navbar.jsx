        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
          ...
          <div className="flex border rounded overflow-hidden">
            <button
              ...
              className={`px-3 py-1 text-sm ${viewMode === 'form' ? 'bg-white text-blue-600' : 'bg-blue-700 text-white'}`}
            ...
            <button
              ...
              className={`px-3 py-1 text-sm ${viewMode === 'results' ? 'bg-white text-blue-600' : 'bg-blue-700 text-white'}`}
            ...
            <button
              ...
              className={`px-3 py-1 text-sm ${viewMode === 'split' ? 'bg-white text-blue-600' : 'bg-blue-700 text-white'}`}
          ...
          {/* <div className="text-xs hidden sm:block">
            <span className="bg-gray-700 text-white px-1 rounded">Ctrl+F</span> Form &nbsp;
            <span className="bg-gray-700 text-white px-1 rounded">Ctrl+R</span> Hasil &nbsp;
            <span className="bg-gray-700 text-white px-1 rounded">Ctrl+S</span> Split
          </div> */}
        </div>
      </div>
    </nav>
