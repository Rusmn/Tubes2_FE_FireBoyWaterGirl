  ...
  useEffect(() => {
    ...
    const simulateSteps = () => {
      ...
      if (algorithm === "bfs") {
        ...
        steps.push({
          message: "Mengunjungi: " + basicElements.join(", "),
          type: "visit",
        });
        steps.push({
          message: "Membuat kombinasi tingkat 1...",
          type: "process",
        });
        steps.push({
        ...
        steps.push({
          message: "Menemukan: " + targetElement + " ditemukan!",
          type: "success",
        });
        ...
        steps.push({
          message: "Pencarian mundur dari " + targetElement + "...",
          type: "process",
        });
        steps.push({
          message: "Menemukan: Steam dari depan",
          type: "discover",
        });
        steps.push({
          message: "Menemukan: Stone dari belakang",
          type: "discover",
        });
        steps.push({
          message: "Pencarian bertemu di tengah!",
          type: "success",
        });
        steps.push({
